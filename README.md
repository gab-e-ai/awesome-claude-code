...
- **[AI Delivery Spec](https://github.com/franklinxkk/ai-delivery-spec)** - Product-side SDD. Turn prototypes into PRDs with FRR, AC-YAML, WBS, risk register. Works with Claude Code, Cursor, Codex.
